...
@st.cache
def convert_df_to_csv(df) -> (int, int, str):
    """store downloaded data as a CSV file"""
...
# to run the app, open the terminal, navigate to the dir in which the
# tech_analysis_app.py script is located, and run the following
# command streamlit run technical_analysis_app.py
